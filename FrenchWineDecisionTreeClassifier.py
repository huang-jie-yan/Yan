...
(X_train,
 X_test,
 Y_train,
 Y_test) = train_test_split(all_inputs, all_species, train_size=0.85, random_state=4)#85%的数据选为训练集
...
[[13.52 3.17 2.72 23.5 97] 
 ...
 """)#利用3个数据进行测试，即取3个数据作为模型的输入端
in_test=[[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[ 13.76,1.53,2.7,19.5,132]]
model.predict(in_test[0:3])
print(model.predict(in_test[0:3]))#输出测试的结果，即输出模型预测的结果
